...
def perform_swap(
    ...
    *,
    ...
    fixed_player_inner = set_single_simple_tag_on_wrapped_inner(fixed_player_inner, "userID", "")
    fixed_farmer_inner = set_single_simple_tag_on_wrapped_inner(fixed_farmer_inner, "userID", old_guest_userid)
    ...
    if savegameinfo_in is not None and output_savegameinfo is not None:
    ...
    print("Swap complete.")
    print("Mode: raw inner-XML swap + mailReceived/homeLocation/userID/reference fixes")
